# Dossier de sponsoring — Norauto

**Statut** : 🔧 En cours — à finaliser avant envoi
**Contact** : via Tintin (développeur Norauto) — interlocuteur interne à identifier
...
Norauto, c'est le partenaire naturel de ce type de projet. Enseigne française, présente depuis des décennies dans le monde de l'automobile, déjà engagée aux côtés d'équipages et d'événements mythiques — vous connaissez la route.

Notre besoin est concret et dans votre cœur de métier : quelques accessoires et équipements pour préparer la 403 au raid. Pas de gadgets, du matériel utile — le genre de choses que Norauto connaît mieux que personne.

Un partenariat en nature, simple et lisible, avec en contrepartie une visibilité originale : votre logo sur une 403 Break de 1960 qui traverse le Maroc. Ce n'est pas tous les jours qu'on voit ça.

---

## 4. Ce qu'on offre à Norauto

- **Sticker(s) grand format** aux couleurs Norauto sur la 403 — visible sur tout le parcours, dans les bivouacs, à l'arrivée
- **Patch Norauto brodé** sur les combinaisons des deux pilotes pendant tout le raid
- **Mentions régulières** sur nos réseaux sociaux : avant le départ, pendant le raid (stories, posts), bilan final
- **Logo Norauto** sur le site du projet avec lien vers votre enseigne : <https://docteurzoidberg.github.io/403/>
- **Logo sur tous nos supports officiels** (dossier presse, documents équipage)
- **Photos et contenu embarqué** partageable par Norauto sur leurs propres réseaux

> Une 403 Break de 1960 avec le logo Norauto dans les dunes du Sahara — un visuel que peu d'enseignes peuvent se payer.

---

## 5. Ce qu'on demande à Norauto

### Partenariat en nature

| Besoin | Référence / détail |
|---|---|
| 4 pneus tout-terrain | General Grabber AT3 — 195/80R15 |
| 1 jerrycan métal | 20L |
| Sangles de remorquage | Sangle cinétique (obligatoire raid) |
| Sangles d'arrimage galerie de toit | Jeu complet |
| Extincteur + support de fixation | 2L, homologué |
| Consommables (huiles moteur, boîte, freins…) | Selon préconisations 403 |

### Option complémentaire
Participation financière partielle à l'inscription Crazy Dust (2 990 € / équipage) — si Norauto souhaite aller au-delà du partenariat en nature.
...
- **Format** : mail personnalisé + ce dossier en PDF
- **Statut** : ⏳ À contacter
