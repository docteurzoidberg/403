...
- Tout ce qui concerne le site (config, deps, build, scripts, ce brief) vit sous `web/`. Seule trace à la racine : l'ajout des entrées `web/.venv/` / `web/build/` dans `.gitignore`.
